; SlideProRelay Installer
; Requires Inno Setup 6 or 7 — https://jrsoftware.org/isdl.php
;
; Build via:  installer\build.ps1
; Or manually: ISCC.exe /DAppVersion=1.0.0 installer\SlideProRelay.iss

#ifndef AppVersion
  #define AppVersion "1.0.0"
#endif

#define AppName      "SlideProRelay"
#define AppExe       "SlideProRelay.Tray.exe"
#define AppPublisher "SlideProRelay"
...
OutputDir=output
OutputBaseFilename=SlideProRelay-{#AppVersion}-Setup
...
Name: "desktopicon"; \
  ...
  Flags: unchecked
Name: "autostart"; \
  Description: "Start SlideProRelay &automatically when Windows starts"; \
